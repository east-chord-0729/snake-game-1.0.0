...
class Wall_G : public Drawable
{
  public:
    Wall_G(int y = 0, int x = 0);
};

class Wall_NG : public Drawable
{
  public:
    Wall_NG(int y = 0, int x = 0);
};
...
class SnakeGame
{
  private:
    ...
    void createApple();
    void destroyApple();
    void createWalls(); // 벽 생성 함수 추가
    void createGate();  // 게이트 생성 함수 추가
